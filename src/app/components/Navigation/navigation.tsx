...
const navItems: NavItem[] = [
  {
    ...
    hasSubmenu: true,
    submenuItems: [
      { label: 'Submenu Item 1', href: '/sales/item1' },
      { label: 'Submenu Item 2', href: '/sales/item2' }
    ]
  },
  {
    key: 'finance',
    ...
    hasSubmenu: true,
    submenuItems: [
      { label: 'Submenu Item 1', href: '/finance/item1' },
      { label: 'Submenu Item 2', href: '/finance/item2' }
    ]
  },
  {
    key: 'warehouse',
    ...
    hasSubmenu: true,
    submenuItems: [
      { label: 'Submenu Item 1', href: '/warehouse/item1' },
      { label: 'Submenu Item 2', href: '/warehouse/item2' }
    ]
  },
  {
    key: 'audit',
    ...
    hasSubmenu: true,
    submenuItems: [
      { label: 'Submenu Item 1', href: '/audit/item1' },
      { label: 'Submenu Item 2', href: '/audit/item2' }
    ]
  },
  {
    key: 'purchasing',
    ...
    hasSubmenu: true,
    submenuItems: [
      { label: 'Submenu Item 1', href: '/purchasing/item1' },
      { label: 'Submenu Item 2', href: '/purchasing/item2' }
    ]
  }
];
      ...
      <div className="mx-auto px-4">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              <IoSettingsSharp className="text-3xl text-theme-gray rounded-full cursor-pointer" />
            </div>
